...
- Source-development desktop: `http://localhost:38473`
...
- `GET /api/search?q=term&limit=50`
- `GET /api/playlists`
...
The server currently caps anonymous public share concurrency; a fourth parallel bootstrap returns `429`.
